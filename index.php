<html>
    ...
    <center>
        <form method="post" action="login.php">
            <table>
                <tr><td colspan="2" style="background-color:#33A8D8; padding-bottom:5px; padding-top:5px;"><label>Login</label></td></tr>
                <tr><td align="center" rowspan="5"><img src="3d-fluency-lock-1.png" alt="Candado"></td><td><label>Usuario</label></td></tr>
